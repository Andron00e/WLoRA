...
from utils_squad import QuestionAnsweringTrainer, squad_preprocess
...
def main():
    ...
    ) = squad_preprocess(data_args, training_args, model_args)
    ...
    training_args.output_dir = (
        f"./squad_experiment/{training_args.output_dir}/{run_name}"
    )
