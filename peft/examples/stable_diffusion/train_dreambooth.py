...
def parse_args(input_args=None):
    ...
    lora.add_argument(
        ...
        type=float,
        default=0.0,
        help="LoRA dropout probability for unet",
    )
    lora.add_argument(
        "--unet_bias",
        type=str,
    ...
    lora.add_argument(
        ...
        type=int,
        default=8,
        help="LoRA rank for text_encoder, only used if `train_text_encoder` is True",
    )
    lora.add_argument(
        "--te_alpha",
        type=int,
    ...
    loha.add_argument(
        ...
        type=float,
        default=0.0,
        help="LoHa rank_dropout probability for unet",
    )
    loha.add_argument(
        "--unet_module_dropout",
        type=float,
        default=0.0,
        help="LoHa module_dropout probability for unet",
    )
    loha.add_argument(
    ...
    loha.add_argument(
        ...
        type=int,
        default=8,
        help="LoHa rank for text_encoder, only used if `train_text_encoder` is True",
    )
    loha.add_argument(
        "--te_alpha",
        type=int,
    ...
    lokr.add_argument(
        ...
        type=float,
        default=0.0,
        help="LoKr rank_dropout probability for unet",
    )
    lokr.add_argument(
        "--unet_module_dropout",
        type=float,
        default=0.0,
        help="LoKr module_dropout probability for unet",
    )
    lokr.add_argument(
        "--unet_use_effective_conv2d",
        action="store_true",
    ...
    lokr.add_argument(
        "--unet_decompose_both",
        action="store_true",
        help="Decompose left matrix in kronecker product for unet",
    )
    lokr.add_argument(
        "--unet_decompose_factor",
        type=int,
        default=-1,
        help="Decompose factor in kronecker product for unet",
    )
    lokr.add_argument(
        "--te_r",
        type=int,
        default=8,
        help="LoKr rank for text_encoder, only used if `train_text_encoder` is True",
    )
    lokr.add_argument(
        "--te_alpha",
        type=int,
